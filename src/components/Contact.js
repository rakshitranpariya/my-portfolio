    ...
    >
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-4 text-gray-600 dark:text-white/50 max-w-2xl mx-auto ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 ">
          ...
          <div className=" rounded-[40px] bg-white/2  dark:bg-black/30  backdrop-blur-sm border border-white/30 dark:!border-black/30 shadow-xl shadow-black/10  p-6 text-center">
            ...
            <h3 className="mt-4 text-lg font-bold text-gray-900 dark:text-white/90">Email</h3>
            <a
              href="mailto:rakshitranpariya@gmail.com"
              className="mt-2 block text-gray-600 dark:text-white/70 hover:text-blue-600 break-words"
            >
          ...
          <div className=" rounded-[40px] bg-white/2  dark:bg-black/30  backdrop-blur-sm border border-white/30 dark:!border-black/30 shadow-xl shadow-black/10  p-6 text-center">
            ...
            <h3 className="mt-4 text-lg font-bold text-gray-900 dark:text-white/90">Phone</h3>
            <a
              href="tel:+17828822958"
              className="mt-2 block text-gray-600 dark:text-white/70 hover:text-blue-600"
            >
              +1 (782) 882-2958
            </a>
          </div>
          ...
          <div className=" rounded-[40px]  bg-white/2 dark:bg-black/30 backdrop-blur-sm border border-white/30 dark:!border-black/30 shadow-xl shadow-black/10 p-6 text-center">
            ...
            <h3 className="mt-4 text-lg font-bold text-gray-900 dark:text-white/90">LinkedIn</h3>
            <a
